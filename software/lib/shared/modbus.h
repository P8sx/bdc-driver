...
#define COIL_REG_JUMP								1U		// Read/Write coil REG, if 1 written jump to APP, if 0 - jump to BOOTLOADER
...
#define INPUT_REG_VERSION_SIZE						30U
	...
	#define COIL_REG_OTW_PERFORM_UPDATE  			1000U	// uint8_t
	...
	#define COIL_REG_VALIDATE_UPDATE 				1001U
	...
	#define HOLDING_REG_MOTOR_TEMP_HYS            	40002U  // float (2 registers)
	#define HOLDING_REG_MOTOR_OVER_TEMP_LIMIT     	40004U  // float (2 registers)

	#define HOLDING_REG_BRIDGE_CURRENT_LIMIT      	40006U  // float (2 registers)
	#define HOLDING_REG_BRIDGE_OVERCURRENT_LIMIT 	40008U  // float (2 registers)

	#define HOLDING_REG_BRIDGE_OVERCURRENT_TIME  	40010U  // uint16_t

	#define HOLDING_REG_PID_KP                    	40012U  // float (2 registers)
	#define HOLDING_REG_PID_KD                    	40014U  // float (2 registers)
	#define HOLDING_REG_PID_KI                    	40016U  // float (2 registers)

	#define HOLDING_REG_POSITION_TOLERANCE       	40018U   // uint16_t
